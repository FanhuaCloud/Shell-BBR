...
function Kernel_Optimize() {
  ...
  echo '#This file parameter is generated by the BBR_Install script, so please don't modify it, and you can make any changes that might cause the kernel to go wrong!
